...
public class MstWalletTypeDto {
	...
	public static String getSchema(String walletTypeSchema) {
		String walletType = "";
		String schema = "MoneyInOut";
		//拼接Schema
		if("IAC".equals(walletTypeSchema)) {
			walletType = "\"" + schema + "\"";
		}else {
			walletType = "\"" + schema + "_" + walletTypeSchema + "\"";
		}
		return walletType;
	}
	
	public static String getSchemaNotQuotes(String walletTypeSchema) {
		String walletType = "";
		String schema = "MoneyInOut";
		//拼接Schema
		if("IAC".equals(walletTypeSchema)) {
